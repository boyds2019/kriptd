...
## Config
rm -rf "$HOME/.deployer/kriptod/"
mkdir -p "$HOME/.deployer/kriptod/"
CONFIG_PATH="$HOME/.deployer/kriptod/config.json"
cat > "$CONFIG_PATH" <<- EOF
{
  "coreIp": "127.0.0.1",
  "p2pPort": 4002,
  ...
  "gitCoreCommit": true,
  "gitCoreOrigin": "https://github.com/boyds2019/kriptd",
  "gitExplorerCommit": true,
  "gitExplorerOrigin": "",
  "licenseName": "codigoaberto",
  "licenseEmail": "danielcds2019@gmail.com"
}
EOF
...
if [ "$NETWORK" == "mainnet" ]; then
    cp "$HOME/.bridgechain/mainnet/kriptod/delegates.json" "$HOME/.config/kriptod-core/mainnet/"
elif [ "$NETWORK" == "devnet" ]; then
    cp "$HOME/.bridgechain/devnet/kriptod/delegates.json" "$HOME/.config/kriptod-core/devnet/"
fi
